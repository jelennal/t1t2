...
@ex.capture
def build_model(act_func, decay, init):
    model = Sequential()
    ...
    model.add(Convolution2D(80, 3, 3, border_mode='same', W_regularizer=l2(decay), init=init))
    model.add(Activation('relu'))

    model.add(HighwayConv2D(80, 3, 3, init=init, border_mode='same', bT_init=-2, activation=act_func, WT_regularizer=l2(decay), WH_regularizer=l2(decay)))
    model.add(HighwayConv2D(80, 3, 3, init=init, border_mode='same', bT_init=-2, activation=act_func, WT_regularizer=l2(decay), WH_regularizer=l2(decay)))
    model.add(HighwayConv2D(80, 3, 3, init=init, border_mode='same', bT_init=-2, activation=act_func, WT_regularizer=l2(decay), WH_regularizer=l2(decay)))
    model.add(HighwayConv2D(80, 3, 3, init=init, border_mode='same', bT_init=-2, activation=act_func, WT_regularizer=l2(decay), WH_regularizer=l2(decay)))
    model.add(HighwayConv2D(80, 3, 3, init=init, border_mode='same', bT_init=-2, activation=act_func, WT_regularizer=l2(decay), WH_regularizer=l2(decay)))
